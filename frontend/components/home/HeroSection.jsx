...
export default function HeroSection() {
  return (
    ...
    >
      <h1 className="font-display text-[48px] xs:text-[56px] sm:text-[80px] md:text-[100px] lg:text-[140px] font-bold leading-[0.85] tracking-tight text-[#1a1a2e] mb-4 sm:mb-6">
        INDIA'S SPORTS
        <br />
      ...
      <p className="text-base sm:text-lg md:text-xl text-[#8697C4] max-w-2xl font-light">
