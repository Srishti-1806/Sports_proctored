  ...
  return (
    <div className="grid grid-cols-12 gap-3 auto-rows-[140px]">
      ...
      <motion.div
        ...
        className="col-span-6 lg:col-span-3 row-span-2 rounded-[24px] bg-white border border-[#EDE8F5] p-4 relative overflow-hidden group hover:border-[#7091E6] transition-colors duration-300"
      >
        <div className="flex flex-col h-full justify-between">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="text-xs text-[#8697C4] font-medium">LIVE</div>
          </div>
      ...
      <motion.div
        ...
        whileHover={{ y: -5 }}
        className="col-span-6 lg:col-span-4 row-span-2 rounded-[24px] bg-[#1a1a2e] p-5 relative overflow-hidden"
      >
            ...
            <div className="flex gap-1">
              {[40, 60, 45, 80, 55, 70, 90].map((height, i) => (
                <motion.div
                  ...
                  className="w-1.5 bg-linear-to-t from-[#7091E6] to-[#ADBBDA] rounded-full"
                />
              ))}
            </div>
            <div className="text-[#7091E6] font-display text-2xl font-bold">94%</div>
          </div>
        </div>
      </motion.div>
      ...
      >
        <div className="flex items-center justify-between h-full">
          ...
          <motion.div
            whileHover={{ x: 5 }}
            className="w-12 h-12 rounded-2xl bg-linear-to-br from-[#3D52A0] to-[#7091E6] flex items-center justify-center"
          >
        ...
        <div className="space-y-2">
          {[['Mumbai', '78'], ['Delhi', '65'], ['Bangalore', '52']].map(([city, count], i) => (
            <motion.div
              ...
              className="flex items-center justify-between p-2 rounded-lg hover:bg-[#EDE8F5] transition-colors"
            >
              <span className="text-sm font-medium text-[#1a1a2e]">{city}</span>
              <span className="text-xs text-[#8697C4]">{count}+</span>
            </motion.div>
          ))}
        </div>
      </motion.div>
      ...
      <motion.div
        ...
        className="col-span-6 lg:col-span-5 row-span-2 rounded-[24px] bg-linear-to-br from-[#3d6df0] to-[#ADBBDA] p-5 relative overflow-hidden"
      >
      ...
      >
        <div className="flex items-center justify-between h-full">
          ...
          <Award className="w-10 h-10 text-[#7091E6]" />
        </div>
      </motion.div>
