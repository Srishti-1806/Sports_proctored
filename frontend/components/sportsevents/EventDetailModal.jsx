        ...
        >
          ...
          <div className="shrink-0 p-4 sm:p-6 bg-linear-to-r from-primary-deep to-primary-bright rounded-t-2xl sm:rounded-t-3xl">
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
              ...
              <span className="px-2.5 sm:px-3 py-1 rounded-full bg-popover/20 text-white text-xs sm:text-sm font-medium">
                {event.type}
              </span>
            </div>
          ...
          <div className="p-4 sm:p-6 space-y-4 sm:space-y-6 overflow-y-auto scrollbar-thin scrollbar-thumb-primary-light scrollbar-track-transparent hover:scrollbar-thumb-primary-bright scrollbar-thumb-rounded-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              <div className="p-3 sm:p-4 rounded-xl bg-primary-soft">
                <div className="flex items-center gap-2 text-primary mb-1">
                  <CalendarDays className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                  <span className="text-xs sm:text-sm font-medium">Date</span>
                </div>
                <p className="font-semibold text-foreground text-sm sm:text-base">{event.date}</p>
              </div>
              <div className="p-3 sm:p-4 rounded-xl bg-primary-soft">
                <div className="flex items-center gap-2 text-primary mb-1">
                ...
                <p className="font-semibold text-foreground text-sm sm:text-base">{event.time}</p>
              </div>
              <div className="p-3 sm:p-4 rounded-xl bg-primary-soft sm:col-span-2">
                <div className="flex items-center gap-2 text-primary mb-1">
                  <MapPin className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                  <span className="text-xs sm:text-sm font-medium">Location</span>
                </div>
                <p className="font-semibold text-foreground text-sm sm:text-base">{event.location}</p>
                <p className="text-xs sm:text-sm text-primary-muted">{event.address}</p>
              </div>
              <div className="p-3 sm:p-4 rounded-xl bg-primary-soft sm:col-span-2">
                <div className="flex items-center gap-2 text-primary mb-1">
            ...
            <div>
              <h3 className="font-display font-bold text-foreground mb-2 sm:mb-3 flex items-center gap-2 text-sm sm:text-base">
                <Target className="w-4 h-4 sm:w-5 sm:h-5 text-primary-bright" />
                Requirements
              </h3>
              <div className="flex flex-wrap gap-2">
                {requirements.map((req, index) => (
                  <span 
                    key={index}
                    className="px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl bg-primary-soft text-primary font-medium text-xs sm:text-sm whitespace-nowrap"
                  >
                    {req}
                  </span>
                ))}
            ...
            {/* Fee */}
            <div className="p-3 sm:p-4 rounded-xl bg-linear-to-r from-primary-soft to-primary-light/30 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
              <div>
                <span className="text-primary-muted text-xs sm:text-sm">Registration Fee</span>
                <p className="font-display text-xl sm:text-2xl font-bold text-primary">{event.fee}</p>
              </div>
              {event.isRegistered ? (
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 rounded-xl bg-linear-to-r from-primary-deep to-primary-bright text-white font-semibold shadow-lg text-sm sm:text-base whitespace-nowrap"
                >
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3">
              <button className="flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-2 px-3 sm:px-4 py-2 sm:py-3 rounded-xl border border-border text-primary font-medium hover:bg-primary-soft transition-colors text-xs sm:text-sm">
