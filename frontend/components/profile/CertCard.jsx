...
export default function CertCard({ data, onDelete }) {
  ...
  return (
    <>
        ...
        <div className="flex gap-4">
          ...
          <div className="w-[70%] flex flex-col justify-between">
            <div className="space-y-2.5">
              <div>
                <p className="text-[10px] font-semibold text-[#8697C4] uppercase tracking-wide mb-0.5">Name</p>
                <h4 className="font-bold text-base text-[#1a1a2e] pr-6">{data.name}</h4>
              </div>
              
              <div>
                <p className="text-[10px] font-semibold text-[#8697C4] uppercase tracking-wide mb-0.5">Organization</p>
                <p className="text-sm font-medium text-blue-600">{data.issuer}</p>
              </div>
              
              {data.year && (
                <div>
                  <p className="text-[10px] font-semibold text-[#8697C4] uppercase tracking-wide mb-0.5">Issue Year</p>
      ...
      {/* Image Modal */}
      {showImage && data.certificateImage && (
