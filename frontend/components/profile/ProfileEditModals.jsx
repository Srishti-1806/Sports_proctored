            ...
            ['speed', 'strength', 'endurance', 'agility', 'flexibility'].map(stat => (
              <div key={stat}>
                ...
                <input
                  ...
                  className="w-full"
                />
                <div className="text-right text-sm font-bold text-[#3D52A0]">{sectionData.value?.[stat] || 0}</div>
              </div>
            ))
          ) : (
            [
              ...
              <div key={key}>
                ...
                <input
                  ...
                  className="w-full"
                />
                <div className="text-right text-sm font-bold text-[#3D52A0]">{sectionData.value?.[key] || 0}</div>
              </div>
            ))
          )}
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <label
                ...
                className="flex items-center justify-center gap-2 w-full px-4 py-3 rounded-xl border-2 border-dashed border-[#ADBBDA] hover:border-[#7091E6] bg-[#EDE8F5]/30 hover:bg-[#EDE8F5]/50 cursor-pointer transition-colors group"
              >
                <svg className="w-5 h-5 text-[#8697C4] group-hover:text-[#7091E6]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                </svg>
                <span className="text-sm font-medium text-[#8697C4] group-hover:text-[#7091E6]">
            ...
            {(sectionData.item?.achievementImage || sectionData.achievementFile) && (
              <div className="mt-3">
                <img 
                  ...
                  className="w-full h-40 object-cover rounded-xl border border-[#ADBBDA]" 
                />
              </div>
            )}
          </div>
