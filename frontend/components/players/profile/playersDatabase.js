  ...
  '1': {
    ...
    assessmentScores: {
      ...
      breakdown: [
        ...
        { name: 'Game IQ', score: 90, icon: BarChart3, color: 'from-[#3D52A0] to-[#7091E6]' },
  ...
  '2': {
    ...
    assessmentScores: {
      ...
      breakdown: [
        ...
        { name: 'Game IQ', score: 89, icon: BarChart3, color: 'from-[#3D52A0] to-[#7091E6]' },
  ...
  '3': {
    ...
    assessmentScores: {
      ...
      breakdown: [
        ...
        { name: 'Technique', score: 84, icon: Target, color: 'from-purple-500 to-pink-400' },
        { name: 'Game IQ', score: 85, icon: BarChart3, color: 'from-[#3D52A0] to-[#7091E6]' },
  ...
  '5': {
    ...
    assessmentScores: {
      ...
      breakdown: [
        ...
        { name: 'Game IQ', score: 87, icon: BarChart3, color: 'from-[#3D52A0] to-[#7091E6]' },
