...
export default function AssessmentScoreCard({ assessmentScores }) {
  return (
    <motion.div
      ...
      className="mb-8 p-6 md:p-8 rounded-3xl bg-linear-to-br from-primary-deep to-primary-bright text-white overflow-hidden relative"
    >
      <div className="absolute top-0 right-0 w-64 h-64 rounded-full bg-popover/5 blur-3xl transform translate-x-1/3 -translate-y-1/3" />
      <div className="absolute bottom-0 left-0 w-48 h-48 rounded-full bg-popover/5 blur-2xl transform -translate-x-1/3 translate-y-1/3" />
      ...
      <div className="relative grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="flex flex-col items-center md:items-end gap-4">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="flex items-center gap-3 px-8 py-4 rounded-2xl bg-card text-primary-deep font-bold shadow-xl hover:shadow-2xl transition-all"
          >
